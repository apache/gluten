...
```
    ...
    mvn clean install -Pbackends-clickhouse -Pdelta -Phadoop-2.7.4 -Pspark-3.5 -Dhadoop.version=2.8.5 -DskipTests -Dcheckstyle.skip
...
#download delta-spark_2.12-3.3.2.jar and delta-storage-3.3.2.jar
wget https://repo1.maven.org/maven2/io/delta/delta-spark_2.12/3.3.2/delta-spark_2.12-3.3.2.jar -P ./jars
wget https://repo1.maven.org/maven2/io/delta/delta-storage/3.3.2/delta-storage-3.3.2.jar -P ./jars
