...
object VeloxSQLQueryTestSettings extends SQLQueryTestSettings {
  ...
  val SUPPORTED_SQL_QUERY_LIST: Set[String] = Set(
    ...
    "udf/udf-count.sql - Scala UDF",
    "udf/udf-cross-join.sql - Scala UDF",
    "udf/udf-having.sql - Scala UDF",
    "udf/udf-inner-join.sql - Scala UDF",
    "udf/udf-join-empty-relation.sql - Scala UDF",
    "udf/udf-natural-join.sql - Scala UDF",
    "udf/udf-outer-join.sql - Scala UDF",
    "union.sql",
    "unpivot.sql",
    "using-join.sql",
    ...
    // TODO: fix on Spark-4.1 "scripting/randomly_generated_scripts.sql",
