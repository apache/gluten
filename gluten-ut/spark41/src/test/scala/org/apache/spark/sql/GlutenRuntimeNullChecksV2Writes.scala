...
class GlutenRuntimeNullChecksV2Writes extends RuntimeNullChecksV2Writes with GlutenSQLTestsTrait {
  ...
  /**
   * Source:
   * https://github.com/apache/spark/blob/v4.1.1/sql/core/src/test/scala/org/apache/spark/sql/RuntimeNullChecksV2Writes.scala#L302
   *
   * Why:
   * https://github.com/apache/spark/blob/v4.1.1/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/analysis/TableOutputResolver.scala#L577
  ...
  /**
   * Source:
   * https://github.com/apache/spark/blob/v4.1.1/sql/core/src/test/scala/org/apache/spark/sql/RuntimeNullChecksV2Writes.scala#L306
   *
   * Why:
   * https://github.com/apache/spark/blob/v4.1.1/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/analysis/TableOutputResolver.scala#L577
   * wraps a map column written to a NOT NULL target in `MapFromArrays(ArrayTransform(MapKeys(..)),
  ...
  /**
   * Source:
   * https://github.com/apache/spark/blob/v4.1.1/sql/core/src/test/scala/org/apache/spark/sql/RuntimeNullChecksV2Writes.scala#L345
   *
   * Why:
   * https://github.com/apache/spark/blob/v4.1.1/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/analysis/TableOutputResolver.scala#L577
   * wraps a map column written to a NOT NULL target in `MapFromArrays(ArrayTransform(MapKeys(..)),
