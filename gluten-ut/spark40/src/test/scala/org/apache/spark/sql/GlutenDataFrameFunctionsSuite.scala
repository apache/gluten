...
class GlutenDataFrameFunctionsSuite extends DataFrameFunctionsSuite with GlutenSQLTestsTrait {
  ...
  /**
   * Source:
   * https://github.com/apache/spark/blob/v4.0.2/sql/core/src/test/scala/org/apache/spark/sql/DataFrameFunctionsSuite.scala#L153
   *
   * Why:
   * https://github.com/apache/spark/blob/v4.0.2/sql/core/src/test/scala/org/apache/spark/sql/DataFrameFunctionsSuite.scala#L156
