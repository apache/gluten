...
class GlutenDataFrameFunctionsSuite extends DataFrameFunctionsSuite with GlutenSQLTestsTrait {
  ...
  /**
   * Source:
   * https://github.com/apache/spark/blob/v3.4.4/sql/core/src/test/scala/org/apache/spark/sql/DataFrameFunctionsSuite.scala#L152
   *
   * Why:
   * https://github.com/apache/spark/blob/v3.4.4/sql/core/src/test/scala/org/apache/spark/sql/DataFrameFunctionsSuite.scala#L155
