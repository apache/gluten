...
VELOX_BRANCH=dft-2026_04_16
VELOX_ENHANCED_BRANCH=ibm-2026_04_16
VELOX_HOME=""
RUN_SETUP_SCRIPT=ON
...
function apply_compilation_fixes {
  ...
  pushd ${VELOX_HOME}
  git apply --check ${CURRENT_DIR}/modify_cudf_fetchcontent.patch
  git apply ${CURRENT_DIR}/modify_cudf_fetchcontent.patch
  popd
}
