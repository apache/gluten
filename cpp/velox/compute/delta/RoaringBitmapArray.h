...
/// This intentionally models the payload format consumed by DeltaDeletionVectorReader:
/// a 4-byte magic number followed by CRoaring's portable Roaring64Map serialization.
