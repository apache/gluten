 ...
 * runtime. GlutenOptimisticTransaction now delegates such writes to the vanilla Delta write path.
 * These tests assert that writing and reading variant data works.
 */
